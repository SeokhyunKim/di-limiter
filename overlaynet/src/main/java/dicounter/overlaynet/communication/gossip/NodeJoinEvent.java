...
@JsonDeserialize(builder = NodeJoinEvent.NodeJoinEventBuilder.class)
public class NodeJoinEvent extends GossipEvent {

    @Builder
    @JsonCreator
    private NodeJoinEvent(@JsonProperty(value = "id") @Nullable final UUID id,
    ...
    public GossipEventType getType() {
        return GossipEventType.NODE_JOIN;
    }
}
